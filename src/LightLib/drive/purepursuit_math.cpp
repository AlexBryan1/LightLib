...
std::vector<odom> Drive::inject_points(std::vector<light::odom> imovements) {
...
double Drive::new_turn_target_compute(double target, double current, light::e_angle_behavior behavior) {
