// ┌─────────────────────────────────────────────────────────────────────────┐
// │                       LEFT DISTANCE-SENSOR MAP                          │
// │                                                                         │
// │  Geometry the LEFT distance sensor raycasts against during MCL.         │
...
float raycast_left(float x, float y, float angleRad, float max_range) {
