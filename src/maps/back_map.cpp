// ┌─────────────────────────────────────────────────────────────────────────┐
// │                       BACK DISTANCE-SENSOR MAP                          │
// │                                                                         │
// │  Geometry the BACK distance sensor raycasts against during MCL.         │
...
float raycast_back(float x, float y, float angleRad, float max_range) {
