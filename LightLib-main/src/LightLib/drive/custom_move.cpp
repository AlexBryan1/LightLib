// ┌───────────────────────────────────────────────────────────────────────────────┐
// │  custom_move.cpp — Custom movement primitives                                   │
// │                                                                               │
...
// │                                                                               │
// │  SETUP:                                                                       │
// │    1. Call custom_move_init(chassis) once in initialize() in main.cpp.          │
...
// ─── Runtime state ───────────────────────────────────────────────────────────
// Pointer to the EZ-Template chassis object.  Set once by custom_move_init() so
