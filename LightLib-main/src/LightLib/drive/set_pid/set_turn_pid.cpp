...
void Drive::pid_turn_behavior_set(light::e_angle_behavior behavior) { default_turn_type = behavior; }
light::e_angle_behavior Drive::pid_turn_behavior_get() { return default_turn_type; }
